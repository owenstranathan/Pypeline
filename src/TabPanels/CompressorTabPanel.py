...
class ListPanel(wx.Panel):
    ...
    def __init__(self, parent, model=None, data=None):
        ...
        b2 = wx.Button(self, label="Add Comp.",size=(65,23))
        self.Bind(wx.EVT_BUTTON, self.OnAddRow, b2)
        b3 = wx.Button(self, label="Del Comp.",size=(65,23))
...
class CompressorInfoPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        list_ctrl1.InsertColumn(0, "CP. NO", width=68)
...
class CompressorPropertiesPanel(wx.Panel):
    def __init__(self, parent):
        ...
        t1 = wx.TextCtrl(panel, -1, "2300", size=(80, -1), style=0)
        t2 = wx.TextCtrl(panel, -1, "2300", size=(80, -1), style=0)
        t3 = wx.TextCtrl(panel, -1, "2300", size=(80, -1), style=0)
        t4 = wx.TextCtrl(panel, -1, "2300", size=(80, -1), style=0)
        ...
        # CONTROLS FOR BOX 2
        box2 = wx.StaticBox(panel, -1, "PROPERTY AND DESIGN" )

        st1 = wx.StaticText(panel, -1, "No. of Serial Compressors", size=(150,-1))
        st2 = wx.StaticText(panel, -1, "Poly. Ef.", size=(50,-1))
        st3 = wx.StaticText(panel, -1, "Cp. Ef.", size=(50,-1))
        st4 = wx.StaticText(panel, -1, "Suct. Temp.")

        spin2 = wx.SpinCtrlDouble(panel, value='1', size=(59,-1),style=wx.SP_ARROW_KEYS,
                                 min=1, max=5, inc=1)
        spin2.SetDigits(0)
        ...
        t5 = wx.TextCtrl(panel, -1, "2300", size=(80, -1), style=0)
        ...
        sizer3 = wx.FlexGridSizer(rows=4, cols=3, hgap=5, vgap=2)
        ...
        box2_sizer.Add(btn1, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER,2 )
...
class WhereLeRibbonWillGo(wx.Frame):
    def __init__(self, parent, id, title, position, size):
        ...
        self.DrawingPanel = CompressorTabPanel(self)
        self.Centre()
        self.Show()
