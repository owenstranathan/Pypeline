...
class ListPanel(wx.Panel):
    ...
    def __init__(self, parent, model=None, data=None):
        ...
        b2 = wx.Button(self, label="Add Loss E.",size=(68,23))
        self.Bind(wx.EVT_BUTTON, self.OnAddRow, b2)
        b3 = wx.Button(self, label="Del Loss E.",size=(65,23))
...
class LossElementInfoPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        list_ctrl1.InsertColumn(0, "L.E. NO", width=68)
        ...
        node_choices = [u"Generic L.E.",u"Typical L.E."]
...
class WhereLeRibbonWillGo(wx.Frame):
    def __init__(self, parent, id, title, position, size):
        ...
        self.DrawingPanel = LossElementTabPanel(self)
        self.Centre()
        self.Show()
