...
class ListPanel(wx.Panel):
    ...
    def __init__(self, parent, model=None, data=None):
        ...
        b2 = wx.Button(self, label="Add Reg.",size=(65,23))
        self.Bind(wx.EVT_BUTTON, self.OnAddRow, b2)
        b3 = wx.Button(self, label="Del Reg.",size=(65,23))
...
class RegulatorInfoPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        list_ctrl1.InsertColumn(0, "RG. NO", width=68)
...
class RegulatorPropertiesPanel(wx.Panel):
    def __init__(self, parent):
        ...
        st1 = wx.StaticText(panel, -1, "No. of Serial Regulators", size=(150,-1))
        st2 = wx.StaticText(panel, -1, "Poly. Ef.", size=(50,-1))
        st3 = wx.StaticText(panel, -1, "Reg. Ef.", size=(50,-1))
...
class WhereLeRibbonWillGo(wx.Frame):
    def __init__(self, parent, id, title, position, size):
        ...
        self.DrawingPanel = RegulatorTabPanel(self)
        self.Centre()
        self.Show()
